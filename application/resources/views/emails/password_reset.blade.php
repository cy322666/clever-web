...
<head>
    ...
    <title>Сброс пароля — Clever Platform</title>
</head>
                ...
                <tr>
                    <td style="padding:24px; color:#262626; font-size:14px; line-height:20px;">
                        <p style="margin:0 0 12px 0;">
                            Здравствуйте, {{ $user->name ?: 'коллеги' }}!
                        </p>

                        <p style="margin:0 0 16px 0;">
                            Мы получили запрос на сброс пароля для аккаунта <b>Clever Platform</b>.
                        </p>
                        ...
                        <div
                            ...
                            <p style="margin:0; font-size:13px; color:#4F4F4F;">
                                ...
                                Ссылка действует: <b style="color:#262626;">{{ $expiresInMinutes }} мин.</b>
                            </p>
                        </div>
