...
class CameSend extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:alfacrm-came-send {transaction} {account} {setting}';
    ...
    public function handle()
    {
        ...
        $statusId = Status::query()->find($setting->status_came_1)->status_id;
