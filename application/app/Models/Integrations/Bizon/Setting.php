...
class Setting extends Model
{
    ...
    public static array $instructionForm = [
        'Создать одну настройку ниже и Сохранить',
        'Скопировать url из поля Регистрационный вебхук',
        'Вставить ее на стороне Бизон в настройках формы',
        'Выполнить остальные настройки',
        'Сохранить настройки',
    ];

    public static array $instructionWeb = [
        'Создать одну настройку ниже и Сохранить',
        'Скопировать url из поля Вебинарный вебхук',
        'Вставить ее на стороне Бизон в настройках комнаты и общих настройках',
        'Выполнить остальные настройки',
        'Сохранить настройки',
    ];
