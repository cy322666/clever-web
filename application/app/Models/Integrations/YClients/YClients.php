...
use App\Models\YclientsException;
...
class YClients
{
     ...
     * URL для RestAPI
     */
    const URL = 'https://api.yclients.ru/api/v1';
    ...
    public function getUserAbonements($company_id, $phone,  $userToken = null)
    {
        ...
        curl_setopt($ch, CURLOPT_URL, self::URL . '/loyalty/certificates?company_id='.$company_id.'&phone='.$phone);
