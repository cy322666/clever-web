...
class Setting extends Model
{
    ...
    public static string $description = 'Локальный сбор сделок, задач и событий amoCRM для будущей аналитики и AI.';

    public static array $instruction = [
        'Модуль периодически забирает сделки и задачи из amoCRM и сохраняет локальные snapshot-данные.',
        'Справочники amoCRM не дублируются: используются существующие статусы, сотрудники и поля.',
        'История изменений строится через сравнение локального snapshot и нового состояния из amoCRM.',
        'На текущем этапе не синкаются вебхуки, звонки, переписки, notes и значения кастомных полей.',
    ];
